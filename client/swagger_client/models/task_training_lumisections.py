...
class TaskTrainingLumisections(object):
    ...
    @property
    def run(self):
        """Gets the run of this TaskTrainingLumisections.  # noqa: E501


        :return: The run of this TaskTrainingLumisections.  # noqa: E501
        :rtype: str
        """
        return self._run
    ...
    @run.setter
    def run(self, run):
        """Sets the run of this TaskTrainingLumisections.


        :param run: The run of this TaskTrainingLumisections.  # noqa: E501
        :type: str
        """
        if run is None:
    ...
    @property
    def _date(self):
        """Gets the _date of this TaskTrainingLumisections.  # noqa: E501


        :return: The _date of this TaskTrainingLumisections.  # noqa: E501
        :rtype: datetime
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this TaskTrainingLumisections.


        :param _date: The _date of this TaskTrainingLumisections.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskTrainingLumisections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskTrainingLumisections):
            return False
